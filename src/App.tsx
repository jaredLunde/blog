...
import heroPlaceholderPhoto from './assets/bali.placeholder.jpg'
import heroPhotoLg from './assets/bali.720.jpg'
import heroPhotoSm from './assets/bali.560.jpg'
...
export function App() {
  return (
    <Column align='center'>
      ...
      <Box width={{min: '100%', md: '80ch'}} pad={{min: 'lg', sm: 'xl'}}>
        <Pages />
      </Box>
    </Column>
  )
